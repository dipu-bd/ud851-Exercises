...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String STORE_QUERY_URL = "query_url";

    // (2) Create a static final key to store the search's raw JSON
    public static final String SEARCH_RAW_JSON = "results";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(savedInstanceState != null) {
            if(savedInstanceState.containsKey(STORE_QUERY_URL)) {
                String url = savedInstanceState.getString(STORE_QUERY_URL);
                mUrlDisplayTextView.setText(url);

                String results = savedInstanceState.getString(SEARCH_RAW_JSON);
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        outState.putString(STORE_QUERY_URL, url);
        ...
        outState.putString(SEARCH_RAW_JSON, result);
    }
